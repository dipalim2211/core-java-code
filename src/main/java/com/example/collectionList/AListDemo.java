...
public class AListDemo {
    ...
    public static void main(String[] args) {
       ...
       // Collections -> java.util -> class
       // Collection -> java.util -> Interface
        ...
        because of key value pair it diff from other and not extend collection
        as collection work on only value
         */

        //Collection nums = new ArrayList();
        //create object of class with reference of interface


        //ArrayList lists = new ArrayList<>();  //Provide Tight Coupling

         List lists = new ArrayList();  //Provide Loose Coupling
